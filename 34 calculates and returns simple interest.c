/* Write a program that reads principal amount, rate of interest and time in the main() function.
Call a function by passing them which calculates and returns simple interest. */
