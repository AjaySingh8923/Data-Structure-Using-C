...
struct books bvar1,bvar2,bvar3 ; // decl. of 3 structure
...
printf("\nBook code = %81u\tPages = %5u\tPrice =%7.2f",bvar1.book_code,bvar1.npages,bvar1.price);
printf("\nBook code = %81u\tPages= %5u\tPrice =%7.2f",bvar2.book_code,bvar2.npages,bvar2.price);
printf("\nBook code = %81u\tPages = %5u\tPrice =%7.2f",bvar3.book_code,bvar3.npages,bvar3.price);
}