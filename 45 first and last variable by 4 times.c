...
In the called function raise the values of the first and last variable by 4 times and lower the values 
of the second and third by half. Now print the updated values back in the calling function main().
