...
Read 3 test scores of a cricketer in main() and call first() that calculates the average score. 
From first() call function second() that prints the smallest score.
