/*Write a program that reads sales of MX number of salespersons in an array. Now display all the sales 
amounts in descending order. Use Selection sort logic.
