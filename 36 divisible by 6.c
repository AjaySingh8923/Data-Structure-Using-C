...
Note that “Divisible by 6” or “Not divisible by 6” should be displayed in the calling function only and not in the called one.
*/
...
char divby6(int val)
{
	if (val%6==0)   // if divisible by 6, remainder will be 0s
